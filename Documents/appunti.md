...
È da notare, inoltre, che la euristica potrebbe essere ancora ottimizzabile, infatti la euristica: $h(n) = 2 \cdot \text{l1 norm}(n, \text{goal})$ cioè Manhattan distance moltiplicata per il costo minimo per passo.
